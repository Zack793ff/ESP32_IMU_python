...
# Replace 'COM27' with the appropriate Bluetooth COM port on your system
...
def read_data():
    ...
    try:
        ...
        print(f"Raw data received: {line}")  # Debugging print
        ...
        try:
            ...
            print(f"Parsed data - ax: {ax}, ay: {ay}, az: {az}")  # Debugging print
